(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [792],
  {
    ...
    3971: (e, t, r) => {
      ...
      function p(e) {
        let t, r;
        let o = Object.assign({}, e.query);
        delete o[u.NEXT_RSC_UNION_QUERY];
        let a = d(e),
          { hostname: l, query: c } = a,
          p = a.pathname;
        a.hash && (p = "" + p + a.hash);
        let h = [],
          _ = [];
        ...
        for (let [r, o] of (l && (t = (0, n.compile)(l, { validate: !1 })),
        Object.entries(c)))
          Array.isArray(o)
            ? (c[r] = o.map((t) => f(s(t), e.params)))
            : "string" == typeof o && (c[r] = f(s(o), e.params));
        ...
        return (
          (a.query = { ...o, ...a.query }),
          { newUrl: r, destQuery: c, parsedDestination: a }
        );
      }
    },
    3996: (e, t, r) => {
    ...
    8276: (e, t, r) => {
      ...
      class Y {
        ...
        async change(e, t, r, n, o) {
          ...
          (eo = (0, P.removeLocale)((0, v.removeBasePath)(eo), q.locale)),
          ...
          try {
            ...
            if (
              ...
              if (
                ((q.isPreview = !!a.props.__N_PREVIEW), a.props.notFound === X)
              ) {
                let e;
                try {
            ...
            let s = n.shallow && q.route === (null != (T = a.route) ? T : ea),
    ...
    9525: (e, t, r) => {
      ...
      function Y(e) {
        var t;
        let { children: r } = e,
          o = E.default.useMemo(() => (0, k.adaptForAppRouterInstance)(n), []);
        return (0, g.jsx)(G, {
          fn: (e) =>
            $({ App: f, err: e }).catch((e) =>
